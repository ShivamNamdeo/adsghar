...
function MostLikedBlogComp({blog_data,blog_id}) {
...
const handleUnLike = (arr,key,author)=>{
	...
	return (
		<div className="most_liked_blog_comp">
			...
			<div className="blog_content">
				<h1>{blog_data.title.substring(0,50)}</h1>
				<h2>{blog_data.desc.substring(0,80)}</h2>
...

			{
				...
				<div className="blog_bottom">
					...
					<Link className="column" to={`/ReadMoreBlogScreen/${blog_id}`} >Read More</Link>		
				</div>
...
export default MostLikedBlogComp